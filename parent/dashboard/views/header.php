            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo URL; ?><?php echo USERTYPE; ?>dashboard/enrollment">
                                <i class="fa fa-th"></i> <span>Enrollment</span> <small class="badge pull-right bg-green">enabled</small>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL; ?><?php echo USERTYPE; ?>dashboard/enrollee">
