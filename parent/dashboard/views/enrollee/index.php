                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                             ...
                                             $appCounter=0;
                                                 $result= $client->select("Select * FROM students WHERE parent_id=:id",array(":id"=>  Session::get('usercodeid')));
...
$appCounter++;
                                                ...
                                                <small><a href='".URL."".USERTYPE."dashboard/delete/".$value['id']."/0' class='btn btn-sm btn-danger'>Delete</a></small>
                                                    </td>
                                            </tr>";
                                                 }
