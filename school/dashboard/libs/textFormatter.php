...
class textFormatter {
    ...
    //put your code here
    public static function sortText($string, $length = 50) {
    ...
    public static function sortStatus($status) {
    ...
    public static function sortInteger($integer) {
    ...
    public static function date($date) {
        ...
        return empty($date) ? date('d/m/y h:m:s') : $date;
    }
...
// Will return the number of days between the two dates passed in
    ...
    public static function sortPriceRange($price, $clientbudget) {
        $budgetpart = array();
        $lowerlimit = $upperlimit = null;
        $newclientbudget = str_replace("$", "", $clientbudget);
        $budgetpart = explode("-", $newclientbudget);
        $lowerlimit = (int) $budgetpart[0];
        $upperlimit = (int) $budgetpart[1];

//echo $lowerlimit;
        return $upperlimit >= $price && $lowerlimit <= $price ? true : false;
    }

    public static function sortDuration($time, $max = 60) {
        return $time > 0 && $time <= $max ? true : false;
    }
