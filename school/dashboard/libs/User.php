...
private function getDetails() {
    ...
    return $this->client->select("SELECT * FROM userschool WHERE id=:id LIMIT 1", array(":id" =>  $this->_userid));
}

public function recordLogOutTime() {
$userid=  Session::get('usercodeid');
    return $this->client->update('userschool', array("lastlogout" => date("d-m-y h:m:s")), "userid='$this->_userid'");
}
