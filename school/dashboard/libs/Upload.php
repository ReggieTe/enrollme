...
class Upload {
    ...
    public static function studentImage($parentId=null,$studentId=null) {
        return "<img src='" . URL ."application/parent/$parentId/images/child$studentId.png' class='img-responsive' alt='Student Image' />";
    }
