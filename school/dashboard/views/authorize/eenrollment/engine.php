...
$require_slip_type = array("image/jpg", "image/jpeg", "image/png","jimage/peg", "image/JPG", "image/PNG");
...
if (isset($child_image_values[0])) {
    ...
    if (!in_array($child_image_values[2], $require_child_type)) {
        ...
        $show = "Invalid format.Please try again";
        require $page;
        include 'views/footer.php';
        exit();
    }
...
//Register User
        ...
        if (!$check->name($user_variables[0])) {
            ...
            if ($client->insert('students', $dataUser)) {
                ...
                Upload::File($slip_image_values[0], $key, "images", "slip", "png");
            ...
            $show = "Error  2 creating account.Please try again";
            include $page;
            include 'views/footer.php';
        }
