                            ...
                            <div class="x_content">
                                  <div class="dashboard-widget-content col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="pull-left col-md-6 col-sm-6 col-xs-12" for="first-name">Name <span class="required text-danger">*</span>
                                            </label>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="pull-left col-md-6 col-sm-6 col-xs-12" for="first-name">Address <span class="required text-danger">*</span>
                                            </label>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <textarea id="lastname" name="description" required="required" class="form-control col-md-7 col-xs-12" rows="5"><?php echo $user->getDescription(); ?></textarea>
                                            </div>
                                        </div>
